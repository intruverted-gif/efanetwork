...
const roster = CHAMPIONSHIP_ROSTERS.find((r) => r.season === 1)!;

const PLACEHOLDER = (name: string) =>
  `data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 60 60'%3E%3Ccircle cx='30' cy='30' r='30' fill='%231a1a2e'/%3E%3Ctext x='30' y='39' text-anchor='middle' fill='%23666' font-size='22' font-family='sans-serif'%3E${encodeURIComponent(name[0].toUpperCase())}%3C/text%3E%3C/svg%3E`;

const AWARDS = [
  { title: 'Season MVP',     player: 'k4masi',         Icon: Trophy,   color: '#facc15', img: 'https://tr.rbxcdn.com/30DAY-AvatarHeadshot-07580A7F9319D0393751027D8CCE97CD-Png/150/150/AvatarHeadshot/Png/noFilter' },
  { title: 'QB of the Year', player: 'k4masi',         Icon: Star,     color: '#f59e0b', img: 'https://tr.rbxcdn.com/30DAY-AvatarHeadshot-07580A7F9319D0393751027D8CCE97CD-Png/150/150/AvatarHeadshot/Png/noFilter' },
  { title: 'RB of the Year', player: 'WorldvsZai',     Icon: Zap,      color: '#60a5fa', img: 'https://tr.rbxcdn.com/30DAY-AvatarHeadshot-C3898109DA64FC26780801E1E8AA9A42-Png/150/150/AvatarHeadshot/Png/noFilter' },
  { title: 'WR of the Year', player: 'mr_devy1122',    Icon: Target,   color: '#f87171', img: 'https://tr.rbxcdn.com/30DAY-AvatarHeadshot-0C2F38FF9A7DF87D366F958990B43940-Png/150/150/AvatarHeadshot/Png/noFilter' },
  { title: 'TE of the Year', player: 'Coltons12_20',   Icon: Activity, color: '#fb923c', img: 'https://tr.rbxcdn.com/30DAY-AvatarHeadshot-41428E3D1324CFF807207792116DFBCF-Png/150/150/AvatarHeadshot/Png/noFilter' },
...
export default function Legacy() {
  return (
    <div style={{ minHeight: '100vh', background: '#050508', color: '#fff', fontFamily: "'Inter', sans-serif", overflowX: 'hidden' }}>
      ...
      {/* Radial ambient glow */}
      <div style={{ position: 'fixed', inset: 0, background: 'radial-gradient(circle at 50% 20%, rgba(45,27,0,0.55) 0%, transparent 65%)', pointerEvents: 'none', zIndex: 0 }} />
      ...
      <nav style={{ position: 'relative', zIndex: 10, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '1.25rem 1.75rem', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        ...
        <div style={{ display: 'flex', gap: '2rem' }}>
          ...
          <Link href="/legacy/season2" style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: '1.5rem', letterSpacing: '0.2em', color: 'rgba(255,255,255,0.2)', borderBottom: '2px solid transparent', paddingBottom: '0.25rem', textDecoration: 'none', transition: 'color .15s' }}
      ...
      <main style={{ position: 'relative', zIndex: 1 }}>
        ...
        {/* ── Hero ── */}
        <section style={{ paddingTop: '5rem', paddingBottom: '4rem', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', padding: '5rem 1.5rem 4rem' }}>
          <p style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 'clamp(5rem, 14vw, 10rem)', letterSpacing: '0.15em', lineHeight: 1, background: 'linear-gradient(180deg, #f5d04a 0%, #ffffff 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', filter: 'drop-shadow(0 0 40px rgba(245,208,74,0.25))', marginBottom: '1rem' }}>
            DYNASTY
          </p>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr auto 1fr', gap: '2rem', alignItems: 'center' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.25rem' }}>
                <div style={{ position: 'relative', width: 140, height: 140, borderRadius: '50%', background: 'rgba(0,0,0,0.5)', border: '1px solid rgba(255,255,255,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <img src="/db-logo.png" alt="Don Bosco" style={{ width: 96, height: 96, objectFit: 'contain' }} />
                  <div style={{ position: 'absolute', inset: -4, borderRadius: '50%', border: `2px solid ${ACCENT}40`, animation: 'spin 12s linear infinite' }} />
                </div>
                <div style={{ textAlign: 'center' }}>
                  <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: '2.5rem', letterSpacing: '0.12em', color: '#fff' }}>DON BOSCO</div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1rem' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
                  <span style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 'clamp(5rem, 10vw, 8rem)', lineHeight: 1, color: '#fff', filter: 'drop-shadow(0 0 30px rgba(255,255,255,0.12))' }}>23</span>
                  <span style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: '3rem', color: 'rgba(255,255,255,0.18)', marginBottom: 12 }}>:</span>
                  <span style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 'clamp(5rem, 10vw, 8rem)', lineHeight: 1, color: 'rgba(255,255,255,0.65)' }}>22</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', padding: '0.4rem 1.1rem', borderRadius: 999, border: `1px solid ${ACCENT}40`, background: `${ACCENT}12` }}>
                  ...
                  <span style={{ fontSize: '0.72rem', fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', color: ACCENT }}>Bowl MVP: k4masi</span>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.25rem', opacity: 0.7 }}>
                <div style={{ width: 140, height: 140, borderRadius: '50%', background: 'rgba(0,0,0,0.5)', border: '1px solid rgba(255,255,255,0.08)', display: 'flex', alignItems: 'center', justifyContent: 'center', filter: 'grayscale(20%)' }}>
                  <img src="/bj-logo.png" alt="Bob Jones" style={{ width: 96, height: 96, objectFit: 'contain' }} />
                </div>
                <div style={{ textAlign: 'center' }}>
                  <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: '2.5rem', letterSpacing: '0.12em', color: '#fff' }}>BOB JONES</div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: '2.5rem' }}>
              {AWARDS.map((award) => (
                <div key={award.title} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}
                  className="dw-award-item">
                  <div style={{ position: 'relative', marginBottom: '1.25rem' }}>
                    <div style={{ width: 88, height: 88, borderRadius: '50%', border: '2px solid rgba(255,255,255,0.1)', background: '#0a0a0f', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                      <img
                        src={award.img}
                        alt={award.player}
                    ...
                    <div style={{ position: 'absolute', bottom: -8, right: -8, width: 30, height: 30, borderRadius: '50%', background: '#111', border: '1px solid rgba(255,255,255,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 2px 8px rgba(0,0,0,0.5)' }}>
        ...
        <section style={{ maxWidth: 1100, margin: '0 auto', padding: '0 1.5rem 6rem' }}>
          <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
            ...
            <p style={{ color: 'rgba(255,255,255,0.4)', textTransform: 'uppercase', letterSpacing: '0.2em', fontSize: '0.75rem', fontWeight: 600 }}>
              The squad that secured the inaugural Geico Bowl victory for Don Bosco
            </p>
          </div>

          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(150px, 1fr))', gap: '1.25rem' }}>
            {roster.players.map((player) => (
              <div key={player.name} className="dw-player-card" style={{ position: 'relative', aspectRatio: '3/4', borderRadius: 16, overflow: 'hidden', background: '#0a0a0f', border: '1px solid rgba(255,255,255,0.08)', cursor: 'default', transition: 'border-color .4s, transform .4s, box-shadow .4s' }}>
                {/* Grid texture */}
                <div style={{ position: 'absolute', inset: 0, backgroundImage: 'linear-gradient(rgba(255,255,255,0.03) 1px, transparent 1px), linear-gradient(90deg, rgba(255,255,255,0.03) 1px, transparent 1px)', backgroundSize: '16px 16px', opacity: 0.5 }} />
                ...
                <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'flex-start', justifyContent: 'center', paddingTop: '1rem' }}>
                  <img
                    ...
                    alt={player.name}
                    style={{ width: '85%', height: '65%', objectFit: 'contain', filter: 'drop-shadow(0 8px 20px rgba(0,0,0,0.8))', transition: 'transform .5s' }}
                ...
                <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, padding: '1.25rem 1rem' }}>
                  <div className="dw-bar" style={{ width: 24, height: 2, background: ACCENT, marginBottom: '0.6rem', transition: 'width .4s' }} />
                  <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: '1.4rem', letterSpacing: '0.08em', color: '#fff', lineHeight: 1.1 }}>{player.name}</div>
                  <div style={{ fontSize: '0.65rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.15em', color: `${ACCENT}70`, marginTop: 4 }}>S1</div>
                </div>
              </div>
            ))}
          </div>
      ...
      <style>{`
        ...
        .dw-player-card:hover { border-color: rgba(245,159,11,0.45) !important; transform: translateY(-6px); box-shadow: 0 20px 40px rgba(0,0,0,0.5), 0 0 30px rgba(245,158,11,0.1); }
        .dw-player-card:hover .dw-bar { width: 48px !important; }
        .dw-award-item:hover img { transform: scale(1.05); }
      `}</style>
    </div>
  );
}
